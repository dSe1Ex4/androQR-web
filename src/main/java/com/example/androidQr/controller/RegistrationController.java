...
@Slf4j
@Controller
@ComponentScan({"com.example.androidQr.generator", "com.example.androidQr.dto"})
...
public class RegistrationController {
    ...
    public String registration(
        ...
        String fileName = qrCodeGenerator.generatedQRCodeImage(textBuilder.toString());
        fileName = "qrimages/" + fileName + ".png";
        try {
            Thread.sleep(1000);
